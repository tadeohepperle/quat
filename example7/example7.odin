...
main :: proc() {
	...
	when false {
		flipbook_img := q.image_load("./assets/smoke_flipbook.png") or_else panic("fire_flipbook.png not found")
		...
		flipbook, err := engine.motion_texture_allocator_allocate_flipbook(&ta, diffuse_img, motion_img, 8, 8, 64)
	} else {
	...
	particles := []q.MotionParticleInstance {
		{pos = {0, 1}, size = {1, 1}, color = q.ColorLightBlue, z = 0, rotation = 0, lifetime = 0, t_offset = 0},
		{pos = {-1.5, 1}, size = {1, 1}, color = q.ColorWhite, z = 0, rotation = 0, lifetime = 0, t_offset = 0.1},
		{pos = {1.5, 1}, size = {1, 1}, color = q.ColorRed, z = 0, rotation = 0, lifetime = 0, t_offset = 3.0},
	}
